...
import com.mpesaflow.api.client.MpesaflowClientImpl
import com.mpesaflow.api.core.ClientOptions
import java.net.Proxy
import java.time.Clock
import java.time.Duration

class MpesaflowOkHttpClient private constructor() {

    companion object {

        @JvmStatic fun builder() = Builder()

        @JvmStatic fun fromEnv(): MpesaflowClient = builder().fromEnv().build()
    }

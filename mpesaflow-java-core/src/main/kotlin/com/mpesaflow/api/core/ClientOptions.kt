...
private constructor(
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://dev.mpesaflow.com/v1"

        const val ENVIRONMENT_1_URL = "https://prod.mpesaflow.com/v1"
    ...
    class Builder {
        ...
        fun fromEnv() = apply { System.getenv("MPESAFLOW_API_KEY")?.let { apiKey(it) } }

...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean {
        // Only retry IOException and MpesaflowIoException, other exceptions are not intended to be
        // retried.
        return throwable is IOException || throwable is MpesaflowIoException
    }

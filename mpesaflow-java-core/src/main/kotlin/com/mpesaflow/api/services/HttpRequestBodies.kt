...
import com.mpesaflow.api.core.MultipartFormValue
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw MpesaflowException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw MpesaflowException("Error serializing value to json", e)
                    }
